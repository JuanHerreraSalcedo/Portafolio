export const translations = {
  ...
  es: {
    ...
    hero: {
      description: 'Construyendo experiencias web modernas y flujos de trabajo inteligentes.',
      descriptionSub: 'Make.com · n8n · Claude AI · MCP Server',
      viewWork: 'Ver proyectos ↓',
    },
    manifesto: {
      quote: 'No solo construyo interfaces —\nconstruyo los sistemas que las impulsan.',
    },
    about: {
      label: 'Quién soy',
      title: 'Sobre mí',
      ...
      bio1rest:
        'apasionado por construir interfaces limpias y flujos de trabajo inteligentes. Desarrollo experiencias web modernas con HTML, CSS, JavaScript, Angular y React — y automatizo procesos complejos usando Make.com, n8n e integraciones REST API.',
      bio2: 'He construido herramientas en producción como una Blueprint API y un MCP Server que conecta flujos de IA con clientes como Claude Desktop y Cursor.',
      bio3pre: 'Apasionado por el',
      bio3ai: 'ecosistema de IA',
      bio3end: '— Claude AI, MCP Servers y diseño inteligente de workflows.',
    ...
    projects: {
      ...
      subtitle:       'Desde juegos de navegador hasta automatización enterprise — proyectos personales, freelance y producción',
  ...
  en: {
    ...
    hero: {
      description:    'Building modern web experiences and intelligent workflows.',
      descriptionSub: 'Make.com · n8n · Claude AI · MCP Server',
      viewWork:       'View Work ↓',
    },
    manifesto: {
      quote: "I don't just build interfaces —\nI build the systems that power them.",
    },
    about: {
      label:    'Who I Am',
      title:    'About Me',
      ...
      bio1rest:
        'passionate about building clean interfaces and intelligent workflows. I craft modern web experiences using HTML, CSS, JavaScript, Angular, and React — and automate complex business processes using Make.com, n8n, and REST API integrations.',
      bio2: "I've built production-grade tools including a Blueprint API and an MCP Server that connects AI workflows to clients like Claude Desktop and Cursor.",
    ...
    projects: {
      ...
      subtitle:       'From browser games to enterprise automation — a mix of personal, freelance, and production work',
      liveDemo:       'Live Demo',
      ...
      items: [
        ...
        {
          title: 'JS Mini Game',
          description: 'Browser game where players collect items before a timer runs out. Built with vanilla JS focusing on game logic and UX.',
        },
        {
          title: 'School Management Platform',
          description: 'Role-based web platform for teachers, admins and parents to manage academic records, grades and school communication.',
        },
        {
          title: 'Lorelis Painting',
          description: 'Custom website for a US-based home remodeling company. Responsive theme, 30% performance improvement, ongoing maintenance.',
        },
        {
          title: 'IgnitePost Workflow Automation',
          description: 'Full automation for direct mail campaigns triggered by Buzz.ai webhooks. Live for SecureAuth and The Signatry clients.',
        },
        {
          title: 'GiftSenda API Integration',
          description: 'End-to-end API integration for The Signatry, handling OAuth flows, access tokens, and vendor coordination.',
        },
      ],
    },
    skills: {
